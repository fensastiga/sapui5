		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App View Catalog",
									"targetURL": "#appviewcaatalog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appviewcaatalog-display": {
								"semanticObject": "appviewcaatalog",
								"action": "display",
								"description": "Aplicacion Fiori Test",
								"title": "App View Catalog",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appviewcaatalog",
									"url": sap.ui.require.toUrl("appviewcaatalog")
								}
							}
						}
					}
