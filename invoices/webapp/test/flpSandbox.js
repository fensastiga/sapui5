		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#chiscoinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chiscoinvoices-display": {
								"semanticObject": "chiscoinvoices",
								"action": "display",
								"description": "invoice aplication",
								"title": "Invoices List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=chisco.invoices",
									"url": sap.ui.require.toUrl("chisco/invoices")
								}
							}
						}
					}
